...
function buildPresetStyles(t) {
  return {
    h1: `color: ${t.primary}; font-size: 26px; font-weight: bold; text-align: center; margin: 40px 0 24px 0; line-height: 1.4;`,
    h2: `color: ${t.primary}; font-size: 20px; font-weight: bold; margin: 36px 0 20px 0; padding-bottom: 8px; border-bottom: 2px solid ${t.h2Border || t.primary}; line-height: 1.4;`,
    h3: `color: ${t.h3Color || t.text}; font-size: 17px; font-weight: bold; margin: 32px 0 16px 0; padding-left: 12px; border-left: 4px solid ${t.h3Border || t.primary}; line-height: 1.4;`,
    h4: `color: ${t.h4Color || t.text}; font-size: 16px; font-weight: bold; margin: 24px 0 12px 0; line-height: 1.4;`,
    p: `margin: 24px 0; line-height: ${t.lineHeight || '1.85'}; color: ${t.text}; font-size: 16px; letter-spacing: ${t.letterSpacing || '0.5px'}; text-align: justify;`,
    strong: `color: ${t.strongColor || t.text}; font-weight: bold;`,
    em: `font-style: italic; color: ${t.emColor || t.text};`,
    del: `text-decoration: line-through; color: ${t.delColor || '#999'};`,
    a: `color: ${t.linkColor || t.primary}; text-decoration: none;${t.aExtra || ''}`,
    ul: 'padding-left: 24px; margin: 24px 0;',
    ol: 'padding-left: 24px; margin: 24px 0;',
    li: `margin: 12px 0; line-height: 1.8; color: ${t.text};`,
    blockquote: `background: ${t.bqBg}; border-left: 4px solid ${t.bqBorder}; border-radius: 0 8px 8px 0; padding: 16px 20px; margin: 28px 2px; color: ${t.bqColor}; font-size: 15px;`,
...
const STYLE_TOKENS = {
  default: {
    primary: '#3b82f6', text: '#333', emColor: '#555', delColor: '#999',
  ...
  minimal: {
    primary: '#111827', text: '#1f2937', strongColor: '#111827',
    emColor: '#374151', delColor: '#9ca3af',
    aExtra: ' border-bottom: 1px solid #d1d5db;',
  ...
  warm: {
    primary: '#f97316', text: '#7c2d12',
    h3Color: '#9a3412', h4Color: '#9a3412', h3Border: '#fb923c',
    strongColor: '#9a3412', emColor: '#9a3412', delColor: '#d97706',
  ...
  zhihu: {
    primary: '#1e80ff', text: '#1f2329', letterSpacing: '0.4px',
    emColor: '#4e5969', delColor: '#86909c',
  ...
  magazine: {
    primary: '#111827', text: '#1f2937', lineHeight: '1.9', letterSpacing: '0.6px',
    h2Border: '#d97706', h3Border: '#d97706',
    strongColor: '#111827', emColor: '#6b7280', delColor: '#9ca3af',
    linkColor: '#b45309',
...
export const STYLE_PRESETS = Object.fromEntries(
  Object.entries({
    ...
    zhihu: '知乎风',
    magazine: '杂志风',
  }).map(([id, label]) => [id, { label, styles: buildPresetStyles(STYLE_TOKENS[id]) }])
);
